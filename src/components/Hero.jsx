                    ...
                    <div className="text-neon-secondary dark:text-cyan-400 font-mono text-lg tracking-wider mb-4 h-8">
                        <Typewriter
                            options={{
                                ...
                                delay: 75,
                                deleteSpeed: 50,
                                wrapperClassName: "text-neon-secondary dark:text-cyan-400 font-mono text-lg tracking-wider",
                                cursorClassName: "text-neon-secondary dark:text-cyan-400 animate-pulse"
                            }}
                        />
                    </div>
